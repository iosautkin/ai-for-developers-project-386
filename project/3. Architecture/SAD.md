...
- Будущие integration tests используют Fastify `inject`, изолированную SQLite database и внедряемый clock.
...
- E2E слоя 4 связывает API-поведение со сценариями слоя 2 и `UIElements.ts`.
